...
def ai_agent(user_input):
    ...
    messages = [
        {"role": "system", "content": """
            You are an AI assistant named BlinkBot developed by Anand Swarup, capable of handling multiple types of requests:
        ...
        [avg_order_value] - Average spending per order in rupees
        ...
        [total_price] - Total cost of the item in rupees
        ...
        [spend] - Total amount spent in rupees
        [revenue_generated] - Revenue earned in rupees
        [roas] - Return on Ad Spend in rupees
"
